  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<center>
        ...
        <h2>
        	...
        	&nbsp;&nbsp;&nbsp;
        	<a href="list">Liste Des Produit</a>
    ...
    <div align="center">
        ...
        <table border="1" cellpadding="5">
        		...
        		<c:if test="${article != null}">
        			<input type="hidden" name="codArt" value="<c:out value='${article.getCodArt()}' />" />
        		</c:if>            
            <tr>
                <th>Nom: </th>
                <td>
                	<input type="text" name="nomArt" size="45"
                			value="<c:out value='${article.getNomArt()}' />"
                		/>
                </td>
            </tr>
            <tr>
                <th>Prix: </th>
                <td>
                	<input type="text" name="pu" size="45"
                			value="<c:out value='${article.getPu()}' />"
                	/>
                </td>
            </tr>
            <tr>
                <th>Qte Stock: </th>
                <td>
                	<input type="text" name="QteStock" size="45"
                			value="<c:out value='${article.getQteStock()}' />"
                	/>
                </td>
            </tr>
