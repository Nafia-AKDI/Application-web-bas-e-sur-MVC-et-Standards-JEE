        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
               ...
               <c:forEach var="article" items="${ listArticle }">
                <tr>
                    <td><c:out value="${article.getCodArt()}" /></td>
                    <td><c:out value="${article.getNomArt()}" /></td>
                    <td><c:out value="${article.getPu()}" /></td>
                      <td><c:out value="${article.getQteStock()}" /></td>
                    <td>
                    	<a href="edit?id=<c:out value='${article.getCodArt()}' />">Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="delete?id=<c:out value='${article.getCodArt()}' />">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
