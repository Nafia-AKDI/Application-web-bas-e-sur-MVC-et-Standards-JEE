...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div align="center">
                <h2>
        	<a href="new">Ajouter un Client</a>
        	&nbsp;&nbsp;&nbsp;
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
               ...
               <c:forEach var="client" items="${ listClient }">
                <tr>
                    <td><c:out value="${client.codCli}" /></td>
                    <td><c:out value="${client.nomCli}" /></td>
                    <td><c:out value="${client.preCli}" /></td>
                    <td><c:out value="${client.adrCli}" /></td>
                     <td><c:out value="${client.telCli}" /></td>
                      <td><c:out value="${client.villeCli}" /></td>
                    <td>
                    	<a href="edit?id=<c:out value='${client.codCli}' />">Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="delete?id=<c:out value='${client.codCli}' />">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
